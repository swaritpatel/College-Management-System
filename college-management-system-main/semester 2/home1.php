    ...
    <div class="logo" id="logo1">
      ...
      <div class="full">
        ...
        <div class="grades"><ul> <li><a href="#" > Grades</a></li></ul></div>
         <div class="mec"> <ul> <li><a href="maths.html" class="mech">Mathematics</a></li>
         ...
         <li><a href="machenics-graphics.html" class="mech">Mechanics and Graphics</a></li>
          ...
          <h3>Error!Your record is not in our database,Please Register Yourself Again</h3>
         <ul><li class="buttn"><input class="blue-button"  value="logout" placeholder="logout" onclick="check2()"></li></ul>
