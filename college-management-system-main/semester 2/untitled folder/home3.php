   ...
   <nav id="navbar">
    <div class="logo" id="logo1">
      ...
      <div class="full">
          ...
          <div class="link"><ul> <li><a href="#" >Attendence</a> </li></ul></div>
          
        <div class="grades"><ul> <li><a href="#" > Grades</a></li></ul></div>
         <div class="mec"> <ul> <li><a href="#" class="mech">Mathematics</a></li>
          <li><a href="#" class="mech">Computer Programming</a></li>
          <li><a href="#" class="mech">Database</a></li>
         <li><a href="#" class="mech">Mechanics and Graphics</a></li>
          <li><a href="#" class="mech">Digital Electronics</a></li></ul></div>
          <ul>
