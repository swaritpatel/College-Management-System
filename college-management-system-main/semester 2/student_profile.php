   ...
   <nav id="navbar">
    <div class="logo" id="logo1">
        <ul class="list">
          ...
          <li class="buttn"><input class="blue-button"  value="Profile" placeholder="Profile" onclick="profile()"></li>
...
if(!$conn)
  ...
  $usn=$_SESSION['username'];
   ...
   if ($result->num_rows > 0) {
    ...
    echo "<p  style='color:black; font-size: 17px;  margin-left: 10rem;'>Gender : $address[7]</p>";
...
function profile()
{
  window.open("http://localhost/semester/update_profile.php")
}
</script>
